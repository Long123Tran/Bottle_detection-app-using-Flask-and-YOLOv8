...
# cap=cv2.VideoCapture("D:/Deep learning/Test_data/Video_test_chai.mp4")
...
model=YOLO("D:/Do_an_tot_nghiep/yolov8/runs/detect/train24/weights/best.pt")
classNames = ["Aquafina", "Ion", "Lavie", "Other brand", "SevenUp"
              ]
prev_time=0
new_time=0
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            #print(box.conf[0]) #box.conf is tensor so we need to convert it to float
